		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#inprotivitiemployeeallocation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"inprotivitiemployeeallocation-display": {
								"semanticObject": "inprotivitiemployeeallocation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=in.protiviti.employeeallocation",
									"url": sap.ui.require.toUrl("in/protiviti/employeeallocation")
								}
							}
						}
					}
