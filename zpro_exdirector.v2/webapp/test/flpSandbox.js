		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zpjprosdskzproexdirector-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpjprosdskzproexdirector-display": {
								"semanticObject": "zpjprosdskzproexdirector",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpj.pro.sd.sk.zproexdirector",
									"url": sap.ui.require.toUrl("zpj/pro/sd/sk/zproexdirector")
								}
							}
						}
					}
