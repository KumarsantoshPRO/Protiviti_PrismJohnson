		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Supply Chain",
									"targetURL": "#zpjprosksdsupplychainzprosupchainzprosupplychain-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpjprosksdsupplychainzprosupchainzprosupplychain-display": {
								"semanticObject": "zpjprosksdsupplychainzprosupchainzprosupplychain",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpj.pro.sk.sd.supplychain.zprosupchain.zprosupplychain",
									"url": sap.ui.require.toUrl("zpj/pro/sk/sd/supplychain/zprosupchain/zprosupplychain")
								}
							}
						}
					}
