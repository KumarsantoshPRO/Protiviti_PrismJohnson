		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "verticalhead",
									"targetURL": "#zpjprosdskzprovertihead-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpjprosdskzprovertihead-display": {
								"semanticObject": "zpjprosdskzprovertihead",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpj.pro.sd.sk.zprovertihead",
