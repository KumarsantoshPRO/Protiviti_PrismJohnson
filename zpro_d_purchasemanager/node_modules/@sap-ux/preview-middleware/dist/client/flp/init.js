...
sap.ui.define(["sap/base/Log", "sap/ui/core/IconPool", "sap/base/i18n/ResourceBundle", "sap/base/util/UriParameters"], function (Log, IconPool, ResourceBundle, UriParameters) {
   ...
   */
  async function registerComponentDependencyPaths(appUrls) {
  ...
  function setI18nTitle() {
    let i18nKey = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'appTitle';
  ...
  async function init(_ref) {
    ...
    if (flex) {
      sap.ushell.Container.attachRendererCreatedEvent(async function () {
        const lifecycleService = await sap.ushell.Container.getServiceAsync('AppLifeCycle');
        lifecycleService.attachAppLoaded(event => {
          ...
          sap.ui.require(libs, function (startAdaptation, pluginScript) {
            const options = {
              rootControl: view,
