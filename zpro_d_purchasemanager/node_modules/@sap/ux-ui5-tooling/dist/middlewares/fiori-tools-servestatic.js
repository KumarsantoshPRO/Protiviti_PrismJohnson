...
var require_depd = __commonJS({
  "../../node_modules/depd/index.js"(exports, module) {
    ...
    function log(message2, site2) {
      ...
      var output2 = format2.call(this, msg, caller, stack2.slice(i));
...
// ../../node_modules/serve-static/node_modules/setprototypeof/index.js
var require_setprototypeof = __commonJS({
  "../../node_modules/serve-static/node_modules/setprototypeof/index.js"(exports2, module2) {
    "use strict";
...
var require_on_finished = __commonJS({
  "../../node_modules/on-finished/index.js"(exports2, module2) {
    ...
    var defer2 = typeof setImmediate === "function" ? setImmediate : function(fn2) {
...
var require_serve_static = __commonJS({
  "../../node_modules/serve-static/index.js"(exports2, module2) {
    ...
    function serveStatic2(root, options) {
      if (!root) {
    ...
    var Colorizer = class _Colorizer {
      ...
      colorize(lookup, level, message2) {
        ...
        if (!Array.isArray(_Colorizer.allColors[lookup])) {
          return colors[_Colorizer.allColors[lookup]](message2);
        }
        for (let i = 0, len = _Colorizer.allColors[lookup].length; i < len; i++) {
          message2 = colors[_Colorizer.allColors[lookup][i]](message2);
        }
        return message2;
      }
      /*
...
var require_errors2 = __commonJS({
  "../../node_modules/logform/errors.js"(exports2, module2) {
    ...
    var format2 = require_format();
    var { LEVEL, MESSAGE } = require_triple_beam();
    module2.exports = format2((einfo, { stack: stack2 }) => {
...
function parse(dateStr, format2, i18n) {
  ...
  var newFormat = format2.replace(literal, function($0, $1) {
    literals.push(regexEscape2($1));
    return "@@@";
  });
  var specifiedFields = {};
  var requiredFields = {};
  newFormat = regexEscape2(newFormat).replace(token, function($0) {
...
var require_setImmediate = __commonJS({
  "../../node_modules/async/internal/setImmediate.js"(exports2) {
    ...
    function wrap(defer2) {
      return (fn2, ...args2) => defer2(() => fn2(...args2));
    }
    var _defer;
    ...
    module2.exports = (options, iter) => {
      ...
      fs.open(options.file, "a+", "0644", (err, fd) => {
        ...
        (function read() {
          ...
          return fs.read(fd, buffer, 0, buffer.length, pos, (error2, bytes) => {
            if (error2) {
              if (!iter) {
  ...
  "../../node_modules/winston/lib/winston/transports/file.js"(exports2, module2) {
    ...
    module2.exports = class File extends TransportStream {
      ...
      log(info, callback = () => {
        ...
        const written = this._stream.write(output2, logged.bind(this));
        if (!written) {
          this._drain = true;
          this._stream.once("drain", () => {
            this._drain = false;
      ...
      query(options, callback) {
        ...
        function push(log3) {
          ...
          if (options.fields) {
            log3 = options.fields.reduce((obj, key) => {
              obj[key] = log3[key];
              return obj;
            }, {});
          }
...
var require_winston = __commonJS({
  "../../node_modules/winston/lib/winston.js"(exports2) {
    ...
    warn2.moved(exports2, "createLogger", "Logger");
  }
});
...
var consoleLogger = {
  type: "logger",
  log: function log2(args2) {
    this.output("log", args2);
  },
  warn: function warn(args2) {
    this.output("warn", args2);
  },
  error: function error(args2) {
    this.output("error", args2);
  },
  output: function output(type, args2) {
    var _console;
    if (console && console[type])
      (_console = console)[type].apply(_console, _toConsumableArray(args2));
  }
};
var Logger = /* @__PURE__ */ function() {
  ...
  _createClass(Logger2, [{
    ...
    key: "forward",
    value: function forward(args2, lvl, prefix, debugOnly) {
      if (debugOnly && !this.debug)
        return null;
      if (typeof args2[0] === "string")
        args2[0] = "".concat(prefix).concat(this.prefix, " ").concat(args2[0]);
    ...
    value: function emit(event) {
      ...
      if (this.observers[event]) {
        ...
        cloned.forEach(function(observer) {
          observer.apply(void 0, args2);
        });
      }
      if (this.observers["*"]) {
        var _cloned = [].concat(this.observers["*"]);
        _cloned.forEach(function(observer) {
          observer.apply(observer, [event].concat(args2));
        });
      }
    }
  }]);
...
function get() {
  return {
    ...
    overloadTranslationOptionHandler: function handle2(args2) {
      var ret = {};
      if (_typeof(args2[1]) === "object")
        ret = args2[1];
      if (typeof args2[1] === "string")
        ret.defaultValue = args2[1];
      if (typeof args2[2] === "string")
        ret.tDescription = args2[2];
      if (_typeof(args2[2]) === "object" || _typeof(args2[3]) === "object") {
        var options = args2[3] || args2[2];
  ...
  _createClass(I18n2, [{
    ...
    value: function init() {
      ...
      if (!this.options.isClone) {
        ...
        s.backendConnector.on("*", function(event) {
          ...
          _this2.emit.apply(_this2, [event].concat(args2));
        });
    ...
    value: function cloneInstance() {
      ...
      clone.translator.on("*", function(event) {
        ...
        clone.emit.apply(clone, [event].concat(args2));
      });
...
module.exports = ({ options, middlewareUtil }) => {
  ...
  const defaultOptions = Object.fromEntries(
    // filter the paths configuration and setHeaders
    Object.entries(configuration).filter(([key]) => {
      return key !== "paths" && key !== "setHeaders";
    })
  );
  for (const config of paths) {
    const overridenOptions = Object.fromEntries(
      // filter the path and src configuration and setHeaders
      Object.entries(config).filter(([key]) => {
        return key !== "path" && key !== "src" && key !== "setHeaders";
      })
    );
