		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "nationalsaleshead",
									"targetURL": "#zpjprosdskzpronatsaleshead-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpjprosdskzpronatsaleshead-display": {
								"semanticObject": "zpjprosdskzpronatsaleshead",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpj.pro.sd.sk.zpronatsaleshead",
									"url": sap.ui.require.toUrl("zpj/pro/sd/sk/zpronatsaleshead")
								}
							}
						}
					}
