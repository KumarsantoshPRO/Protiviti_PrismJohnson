sap.ui.define(['sap/m/MessageBox'], function (MessageBox) {
    ...
    return {
        ...
        itemsPayloadValidation: function (aData, oControl, ) {
        ...
        headerPayloadValidation: function (oControl) {
            ...
            if (!oControl.getView().getModel("JSONModel").getData().KUNNR) {
                MessageBox.error("Please enter Customer Code");
                oControl.getView().byId("idInpCustCode").setValueState("Error");
                headerValidation = 0;
            }
            // else if(!oControl.getView().getModel("JSONModel").getData().TI){
            //     MessageBox.error(" ");
            // }else if(!oControl.getView().getModel("JSONModel").getData().GST){
            //     MessageBox.error(" ");
            // }
            // else if(!oControl.getView().getModel("JSONModel").getData().NAME){
            //     MessageBox.error("Please enter Customer Name");
            // }
            // else if(!oControl.getView().getModel("JSONModel").getData().ACTION){
            //     MessageBox.error(" ");
            // }
            else if (!oControl.getView().getModel("JSONModel").getData().ZTERM) {
                ...
                headerValidation = 0;
            } else if (!oControl.getView().getModel("JSONModel").getData().VALIDITY) {
                ...
                headerValidation = 0;
            } else if (!oControl.getView().getModel("JSONModel").getData().AUFNR) {
                ...
                headerValidation = 0;
            } else if (!oControl.getView().getModel("JSONModel").getData().VTWEG) {
                ...
                headerValidation = 0;
            } else if (!oControl.getView().getModel("JSONModel").getData().VKBUR) {
                ...
                headerValidation = 0;
            } else if (!oControl.getView().getModel("JSONModel").getData().SPART) {
