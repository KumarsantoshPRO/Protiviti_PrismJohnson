...
<head>
    ...
    <script src="<%= ui5.frameworkUrl %><%- ui5.version ? '/' + ui5.version : '' %>/test-resources/sap/ushell/bootstrap/sandbox.js" id="sap-ushell-bootstrap"></script>
    <!-- Bootstrap the UI5 core library -->
    <script id="sap-ui-bootstrap"
        src="<%= ui5.frameworkUrl %><%- ui5.version ? '/' + ui5.version : '' %>/resources/sap-ui-core.js"
