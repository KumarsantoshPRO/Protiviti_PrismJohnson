		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zpjprosksdsalescoordinatorzprosalesco-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpjprosksdsalescoordinatorzprosalesco-display": {
								"semanticObject": "zpjprosksdsalescoordinatorzprosalesco",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpj.pro.sk.sd.salescoordinator.zprosalesco",
									"url": sap.ui.require.toUrl("zpj/pro/sk/sd/salescoordinator/zprosalesco")
								}
							}
						}
					}
