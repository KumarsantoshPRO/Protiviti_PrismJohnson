sap.ui.define(
  [
    ...
    "zpj/pro/sk/sd/salescoordinator/zprosalesco/utils/View2/quality",
    "sap/m/PDFViewer",
      ...
      onRouteMatched: function (oEvent) {
        ...
        if (sID === "null" || sID === undefined) {
          ...
          this.getView()
            ...
            .getHeaderTitle()
            .setObjectTitle("Display Request Details:" + sID.replace(/^0+/, ""));
      ...
      onGenerateBeforeSave: function () {
        ...
        if (headerValidationStatus === 1) {
          ...
          if (itemValidationStatus === 1) {
            ...
            this.getView()
              .getModel()
              .create(sPath, this.getView().getModel("JSONModelPayload").getData(), {
                async: false,
        ...
        for (var j = 0; j < aModelData.length; j++) {
          ...
          for (var i = j + 1; i < aModelData.length; i++) {
            ...
            if (
              ...
              this.getView().getModel("JSONModelPayload").setProperty("/ET_SALES_COORD_ISET/results", aModelData);
              return 0;
            }
          }
        }
