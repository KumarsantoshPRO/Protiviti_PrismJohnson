		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#pjzpurchasemanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pjzpurchasemanager-display": {
								"semanticObject": "pjzpurchasemanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pj.zpurchasemanager",
									"url": sap.ui.require.toUrl("pj/zpurchasemanager")
								}
							}
						}
					}
